...
public class SeekingTask extends BukkitRunnable
{

	Arrow arrow;
	LivingEntity target;

	public SeekingTask(Arrow arrow, LivingEntity target, Plugin plugin)
	{
		this.arrow = arrow;
		this.target = target;
	...
	public void run()
	{
		...
		this.arrow.getWorld().playEffect(this.arrow.getLocation(), Effect.CLOUD, 0);
		this.arrow.getWorld().playEffect(this.arrow.getLocation(), Effect.FLAME, 0);
	}
}